<template>
    <div class="services">
        <dialog-component>
            <div class="services__upload-block">
                <div class="services__upload-btn">
                    <label for="ser_up" class="services__fileupicon"><upload-component class="icon"/> {{ filen }}</label>
                    <input class="services__fileup" id="ser_up" @change="uploadFile" type="file">
                </div>
            </div>
            ...
            <textarea class="services__area" name="" v-model="formData.desc" id="" cols="30" rows="10" placeholder="Text kiriting"></textarea>
...
const postData =()=>{
    ...
    store.dispatch('create', formData)
                formData.title = ''
                formData.img = ''
                formData.desc= ''
...
const getData = (id)=>{
    instance.get('services/'+id).then(res=>{
...
const putData = ()=>{
    store.dispatch('setModal', false)
    store.dispatch('update', {id: upId.value, data: formData})
}
